...
function init(args = { _: [] }) {
    ...
    let admins = [];
    let uname = process.env.DB_USER || args.user || undefined;
    let upass = process.env.DB_PASS || args.pass || undefined;
    let upash = process.env.DB_PASH || args.pash || (upass ? hash(upass) : undefined);
